...
export default function Robot (){
    ...
    we also understand the issues involved with importing new designs to areas like the Seychelles`
        ...
        <div>
            <Embed
                ...
                instructions = "Select the box in the top left corner to view the component tree,
                        isolate sub-components, and select views of the model. Select the ruler in the lower tool tub to measure
