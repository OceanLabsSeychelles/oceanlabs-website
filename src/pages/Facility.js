    ...
    return probes.map((probe, index) => {
      ...
      return (
        ...
        >
          ...
          {!isMobile && (
            <Col sm={3} style={Styles.BootstrapCenter}>
              Probe Name
            </Col>
          )}
      ...
      >
        <Card style={{ textAlign: "center" }}>
          <Card.Body>
            ...
            <Card.Text>
              Facility Status:{" "}
              <Badge bg={"success"}>Within Specifications</Badge>
            </Card.Text>
            <Row style={{ padding: "0.5em" }}>
              <Button variant={"secondary"}>Set Notification Contacts</Button>
            </Row>
            <Row style={{ padding: "0.5em" }}>
              <Button variant={"secondary"}>Send Test Notification</Button>
            </Row>
            <Row style={{ padding: "0.5em" }}>
